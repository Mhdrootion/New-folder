...
namespace JamiaNadwiyya.ViewModels
{
    public class MainViewModel : PageViewModelBase
    {
        public ListViewModel Events { get; private set; }

        public MainViewModel(int visibleItems) : base()
        {
            Title = "Jamia Nadwiyya";
            Events = ViewModelFactory.NewList(new EventsSection(), visibleItems);
